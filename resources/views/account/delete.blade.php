            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Hi <b>{{$user['username']}}</b>! You need to provide your private key to delete your account. All of your messages will be subsequently eradicated.</p>
                        ...
                        <form class="form-horizontal" method="POST" style="display: inline!important;" action="{{route('key.deleteaccount')}}">
                            {{ csrf_field() }}
